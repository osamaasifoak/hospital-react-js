const HospitalisationTableComponent = (props) => {
  return (
    <table className="table" style={{ marginTop: 10 }}>
      ...
      <tbody>
        {props.loadedXML !== undefined &&
          props.loadedXML?.hospitalisations?.hospitalisation.map((element, index) => (
            <tr key={index}>
...
export default HospitalisationTableComponent ;